...
const registratorItems = [
    ...
    {
        label: <NavLink tag={Link} to="/doctors">Доктора</NavLink>,
        key: "2",
    },
    {
...
const doctorItems = [
    ...
    {
        label: <NavLink tag={Link} to="/patientsCard">Медкарта</NavLink>,
        key: "2",
    },
    {
        label: <NavLink tag={Link} to="/doctorsTalons">Принять пациента</NavLink>,
        key: "3",
    }
];
